CREATE DATABASE  IF NOT EXISTS `comercial3` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `comercial3`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: comercial3
-- ------------------------------------------------------
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbnota_BD0`
before delete ON `comercial3`.`tbnota`
FOR EACH ROW
BEGIN
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbnota_item_BI0`
AFTER INSERT ON `comercial3`.`tbnota_item`
FOR EACH ROW
BEGIN
    declare aux char(1);
    declare vqtde int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbnota_item_BU0`
BEFORE UPDATE ON `comercial3`.`tbnota_item`
FOR EACH ROW
begin
    declare aux char(1);
    declare vqtde int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbnota_item_AD0`
AFTER DELETE ON `comercial3`.`tbnota_item`
FOR EACH ROW
begin
    declare aux char(1);
    declare vqtde int;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`permissao_AI0` AFTER INSERT ON `comercial3`.`tbpermissao`
  FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbusuarioAI_0` AFTER INSERT ON `comercial3`.`tbusuario`
  FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbvenda_BD0`
before delete ON `comercial3`.`tbvenda`
FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbvenda_item_BI0`
AFTER INSERT ON `comercial3`.`tbvenda_item`
FOR EACH ROW
BEGIN
    declare vqtde int;	
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbvenda_item_BU0`
BEFORE UPDATE ON `comercial3`.`tbvenda_item`
FOR EACH ROW
BEGIN
    declare vqtde int;
    declare vtipo char(1);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `comercial3`.`tbvenda_item_AD0`
AFTER DELETE ON `comercial3`.`tbvenda_item`
FOR EACH ROW
BEGIN
    declare vqtde int;
    declare vtipo char(1);
...
--
-- Dumping events for database 'comercial3'
--

--
-- Dumping routines for database 'comercial3'
--
